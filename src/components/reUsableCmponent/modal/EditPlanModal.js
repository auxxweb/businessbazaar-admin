...
const EditPlanModal = ({
  ...
  const { plan, getPlanById, loading } = usePlans();

  console.log(plan, "plansss");
...
>
  {loading ? (
    ...
    <form
      ...
      className="p-6 bg-white rounded-lg shadow-md space-y-6 max-h-[80vh] overflow-y-auto"
    >
