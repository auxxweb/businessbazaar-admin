...
function TrashBusiness() {
      ...
      const fetchBusinessData = async () => {
        try {
          const data = await getApi(
            `business/trash-business?page=${page}&limit=${limit}${selectedDesignation !== null
   ...
   console.log(businessData,'uuuuuuuuuuuuuuuuuu')
    const handleSearch = () => {
    ...
    const handleDelete = async (id) => {
      try {
        await deleteApi(`business/admin/undelete/${id}`);
        SetReFetch(!reFetch);
      } catch (error) {
